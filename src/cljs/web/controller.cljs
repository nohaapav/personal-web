...
(defmethod menu-ctrl :elevation-on [_ _ state]
  {:state (assoc state :elevation true)})

(defmethod menu-ctrl :elevation-off [_ _ state]
  {:state (assoc state :elevation false)})
